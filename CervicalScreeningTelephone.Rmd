...
```{r}
population <- as_tibble(read.csv("20190401CSTpopulation.csv"))
seen_Buddini <- as_tibble(read.csv("20190401CSTBuddini.csv"))
refugeeasylum <- as_tibble(read.csv("20190401CSTRefugeeAsylum.csv"))
```
...
population <- population %>%
  ...
  mutate(Age = age(DOB, age.day = as.Date("2019/04/01"))) %>%
...
# list of recording variables to add to Excell sheets
